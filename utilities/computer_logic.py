...
# Otto Matic, the referee, lives in referee.py now. These names stay importable from here
# because hand_flow imports lay_down from this module at call time and referee_proof patches
# it there; moving the definitions must not move the patch point.
from .referee import (SUIT_NAMES, SEARCH_BUDGET, lay_down, autoplay_remaining_cards,   # noqa: E402,F401
                      _legal_leads, _legal_follows, _takes, _sweeps, _plain, _follower_sweeps, _why)
